#############################################################################
# Makefile for building: stable
# Generated by qmake (3.1) (Qt 6.6.2)
# Project:  stable.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile stable.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = stable1.0.0
DISTDIR = /run/media/httpanimations/Files/Code/CDI/stable/.tmp/stable1.0.0
LINK          = g++
...
Makefile: stable.pro /usr/lib64/qt6/mkspecs/linux-g++/qmake.conf /usr/lib64/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt6/mkspecs/common/unix.conf \
		/usr/lib64/qt6/mkspecs/common/linux.conf \
		/usr/lib64/qt6/mkspecs/common/sanitize.conf \
		/usr/lib64/qt6/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents CDI.c $(DISTDIR)/
...
compiler_moc_source_make_all: CDI.moc
...
CDI.moc: CDI.c \
	...
	/usr/lib64/qt6/libexec/moc $(DEFINES) --include /run/media/httpanimations/Files/Code/CDI/stable/moc_predefs.h -I/usr/lib64/qt6/mkspecs/linux-g++ -I/run/media/httpanimations/Files/Code/CDI/stable -I/run/media/httpanimations/Files/Code/CDI/stable -I/usr/include/qt6 -I/usr/include/qt6/QtGui -I/usr/include/qt6/QtCore -I/usr/include/c++/13 -I/usr/include/c++/13/x86_64-redhat-linux -I/usr/include/c++/13/backward -I/usr/lib/gcc/x86_64-redhat-linux/13/include -I/usr/local/include -I/usr/include CDI.c -o CDI.moc
...
CDI.o: CDI.c terminalwindow.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o CDI.o CDI.c
